...
import StudentSelfNotice from "../Pages/Student/stunotice/StudentSelfNotice.jsx";
    ...
    <>
      ...
      >
        ...
        <Routes>
          ...
          <Route path="/stu-notice" element={<Protected Component={StudentSelfNotice} />} />
          {/* user Billing routes */}
        </Routes>
      </main>
    </>
